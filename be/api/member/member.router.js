...
const { controllerGetAll, controllerGetId, controllerAdd, controllerEdit, controllerDelete } = require("./member.controller");
...
router.delete("/:id_member", authorize, IsAdmin, controllerDelete); // admin only
